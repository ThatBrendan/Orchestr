    ...
    children: [
...

      {
        ...
        children: [
          ...
          { path: "areas", alias: "activities", name: "project.commitments", component: () => import("@/views/project/CommitmentsTab.vue") },
          ...
          { path: "settings", name: "project.settings", redirect: to => ({name:"project.overview",params:to.params,query:{settings:"1"}}) },
        ],
      },
    ],
  },
